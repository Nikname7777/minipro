<?php 
session_start();
$connect = mysqli_connect("localhost", "root", "", "bubble");
			...
			<div class="col-md-4">
				<form method="post" action="shop.php?action=add&id=<?php echo $row["id"]; ?>">
					<div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">
						<img src="image/<?php echo $row["image"]; ?>" class="image-responsive" height="230px",width="230px"/><br />
